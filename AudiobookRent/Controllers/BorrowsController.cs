...
namespace AudiobookRent.Controllers
{
    public class BorrowsController : Controller
    {
        ...
        // GET: Borrows/Create
        public ActionResult Create(int BookID, string UserID)
        {
        ...
        public ActionResult Create([Bind(Include = "BorrowID,UserID,BookID")] Borrows borrows)
        {
            borrows.BorrowDate = DateTime.Now;
            borrows.ReturnDate = DateTime.Now.AddDays(7);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BorrowID,UserID,BookID,BorrowDate,ReturnDate")] Borrows borrows)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult BorrowAdd(int BookID, string UserID)
        {
            
            var isExist = db.Borrows.Where(p => p.UserID == UserID && p.BookID == BookID);
