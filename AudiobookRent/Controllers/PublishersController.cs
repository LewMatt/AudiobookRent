...
namespace AudiobookRent.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PublisherID,Name")] Publishers publishers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PublisherID,Name")] Publishers publishers)
        {
            if (ModelState.IsValid)
            {
